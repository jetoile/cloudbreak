...
public enum StackImageUpdateEvent implements FlowEvent {
    ...
    CHECK_IMAGE_VERESIONS_FAILED_EVENT("CHECK_IMAGE_VERESIONS_FAILED_EVENT"),
    CHECK_PACKAGE_VERSIONS_FINISHED_EVENT("CHECK_PACKAGE_VERSIONS_FINISHED_EVENT"),
    CHECK_PACKAGE_VERSIONS_FAILED_EVENT("CHECK_PACKAGE_VERSIONS_FAILED_EVENT"),
    UPDATE_IMAGE_FINESHED_EVENT("UPDATE_IMAGE_FINESHED_EVENT"),
    UPDATE_IMAGE_FAILED_EVENT("UPDATE_IMAGE_FAILED_EVENT");
