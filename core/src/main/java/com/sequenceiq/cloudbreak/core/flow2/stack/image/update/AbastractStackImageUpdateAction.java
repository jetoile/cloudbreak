...
abstract class AbastractStackImageUpdateAction<P extends Payload> extends AbstractAction<StackImageUpdateState, StackImageUpdateEvent, StackContext, P> {
    ...
    protected AbastractStackImageUpdateAction(Class<P> payloadClass) {
        super(payloadClass);
    }
